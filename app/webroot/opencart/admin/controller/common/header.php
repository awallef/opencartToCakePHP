	...
	protected function index() {
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['zone'] = $this->url->link('localisation/zone', 'token=' . $this->session->data['token'], 'SSL');
                        ...
                        /*
                         * cakePHP vars for header template
                         */
                        // Scenes
                        $this->data['cakephp_scenes_url']  = $this->url->link('cakephp/backend/scenes', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['cakephp_scenes_text']  = 'Manage Scenes';
                        
                        // People
                        $this->data['cakephp_people_url']  = $this->url->link('cakephp/backend/people', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['cakephp_people_text']  = 'Manage People';
                        
                        // People
                        $this->data['cakephp_peopletypes_url']  = $this->url->link('cakephp/backend/peopletypes', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['cakephp_peopletypes_text']  = 'Manage People Types';
