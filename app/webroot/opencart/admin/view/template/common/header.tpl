...
<div id="header">
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <!-- cakePHP Link -->
      <li id="custom"><a class="top">CakePHP</a>
        <ul>
          <li><a href="<?php echo $cakephp_scenes_url ?>"><?php echo $cakephp_scenes_text; ?></a></li>
          <li><a href="<?php echo $cakephp_people_url ?>"><?php echo $cakephp_people_text; ?></a></li>
          <li><a href="<?php echo $cakephp_peopletypes_url ?>"><?php echo $cakephp_peopletypes_text; ?></a></li>
        </ul>
      </li>
